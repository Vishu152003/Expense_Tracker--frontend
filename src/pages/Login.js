  ...
  return (
    <div className='bg-slate-800 min-h-screen w-full flex flex-col md:flex-row'>
      ...
      <div className='flex justify-center items-center w-full md:w-3/5 h-auto md:h-screen p-6'>
        <div className='flex flex-col gap-7 w-full sm:w-3/5 md:w-3/5 h-auto pt-10 md:pt-28 items-center'>
          <h1 className='text-3xl sm:text-4xl text-white font-bold -top-10 relative'>Login</h1>
          ...
          <p className='text-white text-sm sm:text-base' >New User ? Go To <a href='/signup' className='underline'>SignUp</a></p>
        </div>
      </div>
    </div>
  )
